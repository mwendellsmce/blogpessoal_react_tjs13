    ...
    async function atualizarUsuario(e: FormEvent<HTMLFormElement>) {
        ...
        if (confirmarSenha === user.senha && user.senha.length >= 8) {
            try {
                ...
                ToastAlert("Usuário atualizado! Efetue o Login Novamente!", "sucesso")
                sucesso()
            } catch (error: any) {
                if (error.toString().includes("401")) {
                    handleLogout()
            ...
            ToastAlert("Dados inconsistentes. Verifique as informações.", "erro")
            setUser({ ...user, senha: "" })
            setConfirmarSenha("")
        }
            ...
            <div className="container mx-auto max-w-7xl">
                <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                    <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr]">
                        <div className="bg-blue-900 p-8 flex flex-col items-center justify-center">
                            ...
                            <p className="text-blue-100 text-base mt-2">{user.usuario}</p>
                        </div>
                        ...
                        <div className="p-8 lg:p-12">
                            ...
                            <form onSubmit={atualizarUsuario} className="space-y-4">
                                ...
                                <div className="flex justify-around gap-8 pt-4">
                                    ...
                                    <button
                                        type="submit"
                                        className="rounded text-white bg-blue-500 hover:bg-blue-800 w-1/2 py-2 flex justify-center font-bold"
                                        disabled={isLoading}
                                    >
                                        {isLoading ? (
